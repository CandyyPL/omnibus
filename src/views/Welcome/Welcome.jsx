        ...
        <Style.CardsWrapper>
          ...
          <div className='card-wrapper'>
            ...
            <div className='card rd'>
              <p>
                Zapomnij o monotonnym powtarzaniu materiału. Omnibus to nie tylko zestawy pytań, ale
                także interaktywne wyzwania, które sprawią, że nauka stanie się fascynująca. Śledź
                swoje postępy, zdobywaj osiągnięcia i rozwijaj się razem z nami!
              </p>
            </div>
          </div>
          <div className='card-wrapper'>
